...
export class EducationDetailsComponent implements OnInit {
  ...
  constructor(public router: Router, public auth: AuthService, public education: EducationService, private activatedRoute: ActivatedRoute, private _location: Location) { }
 ...
 backClicked() {
  ...
  ngOnInit() {
    this. educationId = this.activatedRoute.snapshot.queryParamMap.get('educationId');
    console.log("educationId   "+this.educationId);
    this.education.getYelpEducationDetails(this. educationId).subscribe((response) => {
  ...
  this.education.getYelpEducationReviews(this. educationId).subscribe((response) => {
      this.educationReviews = response.reviews;
