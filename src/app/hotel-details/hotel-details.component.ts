...
export class HotelDetailsComponent implements OnInit {
 ...
 backClicked() {
  ...
  ngOnInit() {
    ...
    this.hotelsService.getYelpHotelsDetails(this. hotelId).subscribe((response) => {
  ...
  this.hotelsService.getYelpHotelsReviews(this. hotelId).subscribe((response) => {
      this.hotelReviews = response.reviews;
