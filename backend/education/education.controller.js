...
var education = {
  ...
  getYelpEducation: function (req, res, next) {
    var location =""
...
console.log(JSON.parse(resp.body).businesses);
      res.json(JSON.parse(resp.body).businesses);
    });
  },
  
  getYelpEducationDetails: function (req, res, next) {
    var id = req.params.id;
      ...
      console.log("aaaaaaaaaaaa" + JSON.parse(resp.body))
      res.json(JSON.parse(resp.body));
    });
  },

  getYelpEducationReviews: function (req, res, next) {
    var id = req.params.id;
