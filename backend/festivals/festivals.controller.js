...
var festivals = {
  ...
  getYelpFestivals: function (req, res, next) {
    var location = '';
...
console.log("yelp resp   "+JSON.stringify(resp));
  ...
  getYelpFestivalsDetails: function (req, res, next) {
  ...
  getYelpFestivalsReviews: function (req, res, next) {
    var id = req.params.id;
